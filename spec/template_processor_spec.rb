    ...
    DATA = {
      ...
      :teacher => '土豪金高端大气上档次哈哈',
           :questions => [
        {
          ...
          :items => [
            {
              :content => "1. ${table:[[\"A\",\"哈哈\",\"测试图片哎\"],[\"V\",\"B\",\"${image2}\"]]}人在恐惧、紧张时，在内脏神经的支配下，肾上腺髓质释放的肾上腺素增多，该激素可用于心脏，使心率加快。下列叙述错误的是（    ）",
          ...
          :items => [
            {
              ...
              '
                ...
                :content => 'pppppppp${table:[["摘要_${2}$_", "总账科目_${2}$_", "明细科目_${2}$_", "√_${2}$_", "借款金额__{10}__", "√_${2}$_", "贷方金额__{10}__", "副单据张_${3}$_"], ["{_}", "{_}", "{_}", "{_}", "千", "百", "十", "万", "千", "百", "十", "元", "角", "分", "{_}", "千", "百", "十", "万", "千", "百", "十", "元", "角", "分", "{_}"], ["", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "{_}"]]}qqqqqqqqqq'
